    ...
    <div className="w-full">
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-[#3d4f5f] text-center mb-6">
            Sektörler
          </h2>
            ...
            {[
              ...
              <a key={index} href={`/sektorler/${sector.slug}`} className="relative group overflow-hidden rounded-lg cursor-pointer block">
                <div className="aspect-[4/3] overflow-hidden relative">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center bg-[#3d4f5f]/30 group-hover:bg-[#3d4f5f]/40 transition-all duration-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <div className="h-[500px] md:h-[650px] max-w-md mx-auto w-full perspective-1000 flip-card">
              <div className="relative w-full h-full flip-card-inner cursor-pointer">
                ...
                {/* Back Face - Ürünler Kategoriler */}
                <div className="absolute inset-0 rotate-y-180 backface-hidden rounded-lg bg-[#3d4f5f] flex flex-col p-8 text-white overflow-y-auto">
                  <h3 className="text-3xl md:text-4xl font-bold mb-6 text-center">Ürünler</h3>
                  <p className="text-lg text-center mb-6">
                    Kusursuz tedarik sürecinizle yakından ilgileniyoruz.
                  </p>
                  <div className="space-y-3 max-w-md mx-auto w-full">
                    <a href="/urunler/yassi-celikler" className="block border-t border-white/30 pt-3 hover:bg-white/10 transition-colors duration-200 rounded px-2">
                      <p className="text-sm md:text-base font-semibold text-center">Yassı Çelikler</p>
                      <p className="text-xs text-gray-300 text-center mt-1">ZAM, galvanizli, boyalı sac ve daha fazlası</p>
                    </a>
                    <a href="/urunler/boru-ve-kutu-profiller" className="block border-t border-white/30 pt-3 hover:bg-white/10 transition-colors duration-200 rounded px-2">
                      <p className="text-sm md:text-base font-semibold text-center">Boru ve Kutu Profiller</p>
                      <p className="text-xs text-gray-300 text-center mt-1">Çelik boru ve profil ürünleri</p>
                    </a>
                    <a href="/urunler/hadde-profil" className="block border-t border-white/30 pt-3 hover:bg-white/10 transition-colors duration-200 rounded px-2">
                      <p className="text-sm md:text-base font-semibold text-center">Hadde Profil Grubu</p>
                      <p className="text-xs text-gray-300 text-center mt-1">İnşaat demiri ve hadde profiller</p>
                    </a>
                  </div>
                </div>
              </div>
            ...
            <div className="h-[500px] md:h-[650px] max-w-md mx-auto w-full perspective-1000 flip-card">
              <div className="relative w-full h-full flip-card-inner cursor-pointer">
                ...
                <div className="absolute inset-0 rotate-y-180 backface-hidden rounded-lg bg-[#3d4f5f] flex flex-col justify-center p-8 text-white">
      ...
      <section className="relative py-16 md:py-24 overflow-hidden">
        <div className="absolute inset-0">
          <img 
            ...
            className="w-full h-full object-cover"
          />
          <div className="absolute inset-0 bg-[#3d4f5f]/50"></div>
        </div>
        
        <div className="relative container mx-auto px-4">
          <div className="flex flex-col items-center text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-[#3d4f5f] mb-8 bg-white inline-block px-4 py-2">
              Hakkımızda
            </h2>
            <div className="max-w-2xl">
              ...
              <a href="/kurumsal/hakkimizda" className="bg-[#3d4f5f] hover:bg-[#1a16a8] text-white font-bold py-3 px-8 rounded transition-colors inline-block">
                DETAYLI BİLGİ
              </a>
            </div>
          </div>
      ...
      <section className="py-16 md:py-24 bg-gray-100 relative overflow-hidden">
        ...
        <div className="relative container mx-auto px-4">
          <div className="max-w-2xl mx-auto text-center">
            <h3 className="text-[#3d4f5f] font-bold text-lg mb-2">
