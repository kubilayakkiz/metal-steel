...
export default function IPEProfillerPageAR() {
    ...
    <div className="w-full">
      <section className="relative py-20 md:py-32 lg:py-40 overflow-hidden text-white">
        <div className="absolute inset-0">
          <img src="/insaatdemiri.jpg" alt="ملفات IPE" className="w-full h-full object-cover" />
          <div className="absolute inset-0 bg-gradient-to-br from-[#3d4f5f]/90 to-[#1a1a5e]/90" />
        </div>
        <div className="relative container mx-auto px-4">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 max-w-3xl">ملفات IPE</h1>
          <p className="text-xl md:text-2xl text-gray-100 max-w-3xl">ملفات عوارض I ذات أجنحة رفيعة IPE</p>
        </div>
      </section>

      <ProductSectionWithImage src="/insaatdemiri.jpg" alt="ملفات IPE" imagePosition="left">
        <h2 className="text-3xl md:text-4xl font-bold text-[#3d4f5f] mb-6">عن المنتج</h2>
        <div className="prose prose-lg max-w-none text-gray-700 space-y-4">
          <p>
            ملفات IPE هي عوارض I ذات أجنحة رفيعة، أخف وزناً وأكثر اقتصاداً من HEA و HEB. تُستخدم على نطاق واسع في الهياكل التي تتطلب قدرة تحميل متوسطة، مثل الجمالونات والهياكل الفولاذية والمنشآت الصناعية.
          </p>
          <p>
            توفر Metal X ملفات IPE من IPE 80 إلى IPE 600 في مجموعة واسعة من الأحجام.
          </p>
        </div>
      </ProductSectionWithImage>

      <ProductSectionWithImage src="/insaatdemiri.jpg" alt="ملفات IPE" imagePosition="right" bgColor="gray">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <ul className="space-y-2 text-gray-700">
              <li>الجمالونات</li>
              <li>البناء الفولاذي الخفيف</li>
              <li>المباني الصناعية</li>
            </ul>
          </div>
        </div>
      </ProductSectionWithImage>
      ...
      <section className="relative py-16 md:py-24 text-white overflow-hidden">
        ...
        <div className="relative container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8 text-gray-100">اتصل بنا للحصول على معلومات تفصيلية وعروض أسعار لملفات IPE.</p>
