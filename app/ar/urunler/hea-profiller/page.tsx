...
export default function HEAProfillerPageAR() {
    ...
    <div className="w-full">
      <section className="relative py-20 md:py-32 lg:py-40 overflow-hidden text-white">
        <div className="absolute inset-0">
          <img src="/insaatdemiri.jpg" alt="ملفات HEA" className="w-full h-full object-cover" />
          <div className="absolute inset-0 bg-gradient-to-br from-[#3d4f5f]/90 to-[#1a1a5e]/90" />
        </div>
        <div className="relative container mx-auto px-4">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 max-w-3xl">ملفات HEA</h1>
          <p className="text-xl md:text-2xl text-gray-100 max-w-3xl">ملفات HEA الأوروبية القياسية (عوارض I)</p>
        </div>
      </section>

      <ProductSectionWithImage src="/insaatdemiri.jpg" alt="ملفات HEA" imagePosition="left">
        <h2 className="text-3xl md:text-4xl font-bold text-[#3d4f5f] mb-6">عن المنتج</h2>
        <div className="prose prose-lg max-w-none text-gray-700 space-y-4">
          <p>
            ملفات HEA (عوارض I الأوروبية) هي ملفات عوارض I قياسية تُستخدم على نطاق واسع في تطبيقات الفولاذ الإنشائي. قوتها وصلابتها العالية تجعلها مثالية لهياكل المباني والجسور والمنشآت الصناعية.
          </p>
          <p>
            توفر Metal X ملفات HEA من HEA 100 إلى HEA 1000، وفقًا لمعايير EN 10365.
          </p>
        </div>
      </ProductSectionWithImage>

      <ProductSectionWithImage src="/insaatdemiri.jpg" alt="ملفات HEA" imagePosition="right" bgColor="gray">
      ...
      <section className="relative py-16 md:py-24 text-white overflow-hidden">
        ...
        <div className="relative container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8 text-gray-100">اتصل بنا للحصول على معلومات تفصيلية وعروض أسعار لملفات HEA.</p>
