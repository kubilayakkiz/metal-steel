...
export default function OtomotivPageAR() {
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
                ...
                <a href={getPathWithLocale('/urunler/sicak-haddelenmis-sac', locale)} className="text-[#3d4f5f] font-semibold hover:underline">
              ...
              <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
                ...
                <a href={getPathWithLocale('/urunler/soguk-haddelenmis-sac', locale)} className="text-[#3d4f5f] font-semibold hover:underline">
                  {t.sectors.otomotiv.viewDetails}
                </a>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
                ...
                <a href={getPathWithLocale('/urunler/galvanizli-sac', locale)} className="text-[#3d4f5f] font-semibold hover:underline">
                  {t.sectors.otomotiv.viewDetails}
                </a>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
                ...
                <a href={getPathWithLocale('/urunler/zam', locale)} className="text-[#3d4f5f] font-semibold hover:underline">
                  {t.sectors.otomotiv.viewDetails}
                </a>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
                ...
                <a href={getPathWithLocale('/iletisim', locale)} className="text-[#3d4f5f] font-semibold hover:underline">
