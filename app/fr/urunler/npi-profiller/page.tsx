...
export default function NPIProfillerPageFR() {
    ...
    <div className="w-full">
      <section className="relative py-20 md:py-32 lg:py-40 overflow-hidden text-white">
        <div className="absolute inset-0">
          <img src="/insaatdemiri.jpg" alt="Profils NPI" className="w-full h-full object-cover" />
          <div className="absolute inset-0 bg-gradient-to-br from-[#3d4f5f]/90 to-[#1a1a5e]/90" />
        </div>
        <div className="relative container mx-auto px-4">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 max-w-3xl">Profils NPI</h1>
          <p className="text-xl md:text-2xl text-gray-100 max-w-3xl">Profils en U (cornières) – série NPI</p>
        </div>
      </section>

      <ProductSectionWithImage src="/insaatdemiri.jpg" alt="Profils NPI" imagePosition="left">
        <h2 className="text-3xl md:text-4xl font-bold text-[#3d4f5f] mb-6">À propos du produit</h2>
        <div className="prose prose-lg max-w-none text-gray-700 space-y-4">
          <p>
            Les profils NPI, également appelés profilés en U ou profilés en C, sont des profilés en acier à section ouverte. Leurs ailes parallèles facilitent l&apos;assemblage et le montage. Ils sont utilisés dans les systèmes de cadres, structures de machines et éléments de support structurel.
          </p>
          <p>
            Metal X fournit des profils NPI de NPI 65 à NPI 380 en dimensions standard.
          </p>
        </div>
      </ProductSectionWithImage>

      <ProductSectionWithImage src="/insaatdemiri.jpg" alt="Profils NPI" imagePosition="right" bgColor="gray">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <ul className="space-y-2 text-gray-700">
              ...
              <li>Profilé en U à ailes parallèles</li>
            </ul>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md">
            <h3 className="text-xl font-bold text-[#3d4f5f] mb-4">Applications</h3>
            <ul className="space-y-2 text-gray-700">
              <li>Systèmes de cadres</li>
              <li>Structures de machines</li>
              <li>Éléments de support structurel</li>
            </ul>
          </div>
        </div>
      </ProductSectionWithImage>
      ...
      <section className="relative py-16 md:py-24 text-white overflow-hidden">
        ...
        <div className="relative container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8 text-gray-100">Contactez-nous pour des informations détaillées et des devis sur nos profils NPI.</p>
