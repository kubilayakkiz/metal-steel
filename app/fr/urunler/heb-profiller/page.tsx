...
export default function HEBProfillerPageFR() {
    ...
    <div className="w-full">
      <section className="relative py-20 md:py-32 lg:py-40 overflow-hidden text-white">
        <div className="absolute inset-0">
          <img src="/insaatdemiri.jpg" alt="Profils HEB" className="w-full h-full object-cover" />
          <div className="absolute inset-0 bg-gradient-to-br from-[#3d4f5f]/90 to-[#1a1a5e]/90" />
        </div>
        <div className="relative container mx-auto px-4">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 max-w-3xl">Profils HEB</h1>
          <p className="text-xl md:text-2xl text-gray-100 max-w-3xl">Profils en I à ailes larges HEB</p>
        </div>
      </section>

      <ProductSectionWithImage src="/insaatdemiri.jpg" alt="Profils HEB" imagePosition="left">
        <h2 className="text-3xl md:text-4xl font-bold text-[#3d4f5f] mb-6">À propos du produit</h2>
        <div className="prose prose-lg max-w-none text-gray-700 space-y-4">
          <p>
            Les profils HEB présentent des ailes plus larges que les profils HEA, offrant une résistance et une capacité de moment plus élevées. Ils sont privilégiés pour les usines industrielles, les structures d&apos;entrepôts et les bâtiments à grande portée nécessitant une charge lourde.
          </p>
          <p>
            Metal X fournit des profils HEB de HEB 100 à HEB 1000 en dimensions standard.
          </p>
        </div>
      </ProductSectionWithImage>

      <ProductSectionWithImage src="/insaatdemiri.jpg" alt="Profils HEB" imagePosition="right" bgColor="gray">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <ul className="space-y-2 text-gray-700">
              ...
              <li>Avantage des ailes larges</li>
            </ul>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md">
            <h3 className="text-xl font-bold text-[#3d4f5f] mb-4">Applications</h3>
            <ul className="space-y-2 text-gray-700">
              <li>Usines industrielles</li>
              <li>Entrepôts et hangars</li>
              <li>Systèmes de charge lourde</li>
            </ul>
          </div>
        </div>
      </ProductSectionWithImage>
      ...
      <section className="relative py-16 md:py-24 text-white overflow-hidden">
        ...
        <div className="relative container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8 text-gray-100">Contactez-nous pour des informations détaillées et des devis sur nos profils HEB.</p>
