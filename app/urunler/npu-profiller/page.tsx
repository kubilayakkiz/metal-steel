...
export const metadata: Metadata = {
  title: 'NPU Profiller - Metal X Endüstriyel San. ve Tic. LTD. ŞTİ.',
  description: 'NPU (U-profiller) profiller. Geniş tabanlı kanal profiller, yapısal çelik ve montaj uygulamaları.',
};

export default function NPUProfillerPage() {
  return (
    <div className="w-full">
      <section className="relative py-20 md:py-32 lg:py-40 overflow-hidden text-white">
        <div className="absolute inset-0">
          <img src="/insaatdemiri.jpg" alt="NPU Profiller" className="w-full h-full object-cover" />
          <div className="absolute inset-0 bg-gradient-to-br from-[#3d4f5f]/90 to-[#1a1a5e]/90" />
        </div>
        <div className="relative container mx-auto px-4">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 max-w-3xl">NPU Profiller</h1>
          <p className="text-xl md:text-2xl text-gray-100 max-w-3xl">
            Geniş tabanlı kanal (U) profiller – NPU serisi
          </p>
        </div>
      </section>

      <ProductSectionWithImage src="/insaatdemiri.jpg" alt="NPU Profiller" imagePosition="left">
        <h2 className="text-3xl md:text-4xl font-bold text-[#3d4f5f] mb-6">Ürün Hakkında</h2>
        <div className="prose prose-lg max-w-none text-gray-700 space-y-4">
          <p>
            NPU profiller, NPI profillere göre daha geniş tabanlı U-kanal profillerdir. Daha iyi stabilite ve yük
            dağılımı sağlar. Ağır yük taşıma, makine ayakları ve endüstriyel konstrüksiyonlarda tercih edilir.
          </p>
          <p>
            Metal X olarak NPU 65’ten NPU 400’e kadar standart NPU profiller sunmaktayız.
          </p>
        </div>
      </ProductSectionWithImage>

      <ProductSectionWithImage src="/insaatdemiri.jpg" alt="NPU Profiller" imagePosition="right" bgColor="gray">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <ul className="space-y-2 text-gray-700">
              ...
              <li>Geniş tabanlı kanal</li>
            </ul>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md">
            <h3 className="text-xl font-bold text-[#3d4f5f] mb-4">Uygulama Alanları</h3>
            <ul className="space-y-2 text-gray-700">
              <li>Ağır yük taşıma</li>
              <li>Makine ayakları</li>
              <li>Endüstriyel konstrüksiyon</li>
            </ul>
          </div>
        </div>
      </ProductSectionWithImage>
      ...
      <section className="relative py-16 md:py-24 text-white overflow-hidden">
        ...
        <div className="relative container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8 text-gray-100">NPU profil ürünlerimiz hakkında detaylı bilgi ve teklif için bizimle iletişime geçin.</p>
