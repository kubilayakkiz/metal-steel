...
export const metadata: Metadata = {
  title: 'Sıcak Haddelenmiş Asitlenmiş Sac - Metal X Endüstriyel San. ve Tic. LTD. ŞTİ.',
  description: 'Sıcak haddelenmiş asitlenmiş sac ürünleri. Yüksek kalite standartları, üretim limitleri ve teknik özellikler hakkında bilgi.',
};
      ...
      <section className="relative py-20 md:py-32 lg:py-40 overflow-hidden text-white">
        <div className="absolute inset-0">
          <img 
            ...
            alt="Sıcak Haddelenmiş Asitlenmiş Sac"
        ...
        <div className="relative container mx-auto px-4">
          ...
          <p className="text-xl md:text-2xl text-gray-100 max-w-3xl">
            Yüksek kaliteli sıcak haddelenmiş asitlenmiş sac ürünleri
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none text-gray-700 space-y-4">
              <p>
                Sıcak haddelenmiş asitlenmiş sac, yüksek sıcaklıkta haddeleme işlemi sonrası 
                yüzey temizleme işleminden geçirilen çelik sac ürünüdür. Bu işlem, sacın yüzeyindeki 
                oksit tabakasını kaldırarak temiz ve pürüzsüz bir yüzey elde edilmesini sağlar.
              </p>
              <p>
                Metal X Endüstriyel San. ve Tic. LTD. ŞTİ.'in sıcak haddelenmiş asitlenmiş sac ürünleri, otomotiv, yapı, 
                makine imalatı ve genel endüstriyel uygulamalarda yaygın olarak kullanılmaktadır. 
                Ürünlerimiz, yüksek kalite standartlarına uygun olarak üretilmekte ve müşterilerimizin 
                en yüksek beklentilerini karşılamaktadır.
              </p>
              <p>
                Esneklik, işlenebilirlik ve ekonomik fiyat avantajları ile sıcak haddelenmiş 
                asitlenmiş sac, birçok uygulama için ideal bir seçimdir.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <ul className="space-y-2 text-gray-700">
                  ...
                  <li className="flex items-center gap-2">
                    ...
                    <span>Standart kalınlıklar: 2.0, 2.5, 3.0, 4.0, 5.0, 6.0, 8.0, 10.0, 12.0, 15.0, 20.0 mm</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                <h3 className="text-xl font-bold text-[#3d4f5f] mb-4">Ağırlık</h3>
                <ul className="space-y-2 text-gray-700">
                  <li className="flex items-center gap-2">
                    <svg className="w-5 h-5 text-[#3d4f5f]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                    </svg>
                    <span>Minimum sipariş: 5 ton</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <svg className="w-5 h-5 text-[#3d4f5f]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                    </svg>
                    <span>Maksimum sipariş: 500 ton</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <svg className="w-5 h-5 text-[#3d4f5f]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                    </svg>
                    <span>Daha büyük siparişler için özel teklif alınabilir</span>
                  </li>
                </ul>
              </div>
            </div>
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                ...
                <ul className="space-y-2 text-gray-700">
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span><strong>DIN 17100:</strong> Alman çelik standardı</span>
                  </li>
                </ul>
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-gray-700">
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>• Çekme dayanımı: 360-510 N/mm²</li>
                      <li>• Akma dayanımı: ≥ 235 N/mm²</li>
                      <li>• Uzama: ≥ 20%</li>
                      <li>• Sertlik: HRB 60-80</li>
                    </ul>
                  </div>
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>• Karbon (C): ≤ 0.20%</li>
                      <li>• Mangan (Mn): ≤ 1.50%</li>
                      <li>• Fosfor (P): ≤ 0.050%</li>
                      <li>• Kükürt (S): ≤ 0.050%</li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                ...
                <ul className="space-y-2 text-gray-700">
                  <li className="flex items-start gap-2">
                    ...
                    <span>Asitlenme işlemi ile oksit tabakası tamamen temizlenir</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <svg className="w-5 h-5 text-[#3d4f5f] mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                    <span>Pürüzsüz ve temiz yüzey kalitesi</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <svg className="w-5 h-5 text-[#3d4f5f] mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                    <span>Boya ve kaplama uygulamalarına uygun yüzey</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <svg className="w-5 h-5 text-[#3d4f5f] mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
        ...
        <div className="relative container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8 text-gray-100">
              Sıcak haddelenmiş asitlenmiş sac ürünlerimiz hakkında detaylı bilgi ve teklif için bizimle iletişime geçin.
            </p>
