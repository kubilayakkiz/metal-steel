...
export default function SicakHaddelenmisSacPage() {
  return (
    <div className="w-full">
      ...
      <ProductSectionWithImage src="/sicakhaddelenmissac.jpg" alt="Sıcak Haddelenmiş Sac" imagePosition="left">
      ...
      <ProductSectionWithImage src="/sicakhaddelenmissac.jpg" alt="Sıcak Haddelenmiş Sac" imagePosition="right" bgColor="gray">
