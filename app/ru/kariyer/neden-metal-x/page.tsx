          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
                <div className="w-12 h-12 bg-[#3d4f5f]/10 rounded-full flex items-center justify-center mb-4">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                <div className="w-8 h-8 bg-[#3d4f5f]/10 rounded-full flex items-center justify-center flex-shrink-0">
                  <svg className="w-5 h-5 text-[#3d4f5f]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                </div>
                <div>
                  <h3 className="text-xl font-bold text-[#3d4f5f] mb-2">{t.career.nedenMetalX.reliability}</h3>
                  <p className="text-gray-700">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-[#3d4f5f] mb-2">{t.career.nedenMetalX.excellence}</h3>
                  <p className="text-gray-700">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-[#3d4f5f] mb-2">{t.career.nedenMetalX.innovation}</h3>
                  <p className="text-gray-700">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-[#3d4f5f] mb-2">{t.career.nedenMetalX.valuesTeamwork}</h3>
                  <p className="text-gray-700">
        ...
        <div className="relative container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href={getPathWithLocale('/kariyer/basvuru', locale)} className="px-8 py-4 bg-white text-[#3d4f5f] font-bold rounded-lg hover:bg-gray-100 transition-colors">
