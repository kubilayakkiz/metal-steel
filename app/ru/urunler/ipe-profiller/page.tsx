...
export default function IPEProfillerPageRU() {
    ...
    <div className="w-full">
      <section className="relative py-20 md:py-32 lg:py-40 overflow-hidden text-white">
        <div className="absolute inset-0">
          <img src="/insaatdemiri.jpg" alt="Профили IPE" className="w-full h-full object-cover" />
          <div className="absolute inset-0 bg-gradient-to-br from-[#3d4f5f]/90 to-[#1a1a5e]/90" />
        </div>
        <div className="relative container mx-auto px-4">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 max-w-3xl">Профили IPE</h1>
          <p className="text-xl md:text-2xl text-gray-100 max-w-3xl">Тонкополочные двутавровые балки IPE</p>
        </div>
      </section>

      <ProductSectionWithImage src="/insaatdemiri.jpg" alt="Профили IPE" imagePosition="left">
        <h2 className="text-3xl md:text-4xl font-bold text-[#3d4f5f] mb-6">О продукте</h2>
        <div className="prose prose-lg max-w-none text-gray-700 space-y-4">
          <p>
            Профили IPE — тонкополочные двутавры, легче и экономичнее HEA и HEB. Применяются в стропильных фермах,
            каркасных зданиях и промышленных сооружениях со средней нагрузкой.
          </p>
          <p>Metal X поставляет профили IPE от IPE 80 до IPE 600.</p>
        </div>
      </ProductSectionWithImage>

      <ProductSectionWithImage src="/insaatdemiri.jpg" alt="Профили IPE" imagePosition="right" bgColor="gray">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <ul className="space-y-2 text-gray-700">
              <li>Стропильные фермы</li>
              <li>Легкие стальные конструкции</li>
            </ul>
          </div>
        </div>
      </ProductSectionWithImage>
      ...
      <section className="relative py-16 md:py-24 text-white overflow-hidden">
        ...
        <div className="relative container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8 text-gray-100">Свяжитесь с нами для получения информации по профилям IPE.</p>
