  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="text-center">
        <h1 className="text-6xl font-bold text-[#3d4f5f] mb-4">404</h1>
        ...
        <Link 
          href="/" 
          className="inline-block px-6 py-3 bg-[#3d4f5f] text-white rounded-lg hover:bg-[#1a1a5e] transition-colors"
        >
          Ana Sayfaya Dön
        </Link>
      </div>
