          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-gray-50 p-8 rounded-lg">
                <h3 className="text-xl font-bold text-[#3d4f5f] mb-4">{t.corporate.kurumsalKimlik.darkBackground}</h3>
                <div className="bg-[#3d4f5f] p-6 rounded-lg flex items-center justify-center">
                  <img 
              ...
              <div className="bg-gray-50 p-8 rounded-lg">
                <h3 className="text-xl font-bold text-[#3d4f5f] mb-4">{t.corporate.kurumsalKimlik.lightBackground}</h3>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-white p-6 rounded-lg shadow-md">
                <h3 className="text-xl font-bold text-[#3d4f5f] mb-4">{t.corporate.kurumsalKimlik.primaryColor}</h3>
                <div className="flex items-center gap-4 mb-4">
                  <div className="w-24 h-24 bg-[#3d4f5f] rounded-lg shadow-md"></div>
                  <div>
                    <p className="font-semibold text-gray-700">#3d4f5f</p>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                <h3 className="text-xl font-bold text-[#3d4f5f] mb-4">{t.corporate.kurumsalKimlik.accentColor}</h3>
                <div className="flex items-center gap-4 mb-4">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="text-xl font-bold text-[#3d4f5f] mb-4">{t.corporate.kurumsalKimlik.mainFont}</h3>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-white p-6 rounded-lg shadow-md text-center">
                <div className="w-16 h-16 bg-[#3d4f5f] rounded-full flex items-center justify-center mx-auto mb-4">
                  <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                </div>
                <h3 className="text-lg font-bold text-[#3d4f5f] mb-2">{t.corporate.kurumsalKimlik.reliability}</h3>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md text-center">
                ...
                <h3 className="text-lg font-bold text-[#3d4f5f] mb-2">{t.corporate.kurumsalKimlik.innovation}</h3>
                <p className="text-gray-600 text-sm">
              ...
              <div className="bg-white p-6 rounded-lg shadow-md text-center">
                ...
                <h3 className="text-lg font-bold text-[#3d4f5f] mb-2">{t.corporate.kurumsalKimlik.sustainability}</h3>
                <p className="text-gray-600 text-sm">
