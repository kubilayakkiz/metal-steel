        ...
        <div className="relative container mx-auto px-4">
          <div className="flex flex-col items-center text-center">
            ...
            <div className="max-w-2xl">
              ...
              <a href={getPathWithLocale('/kurumsal/hakkimizda', locale)} className="bg-[#3d4f5f] hover:bg-[#1a16a8] text-white font-bold py-3 px-8 rounded transition-colors inline-block">
                {t.home.about.button}
              </a>
            </div>
          </div>
