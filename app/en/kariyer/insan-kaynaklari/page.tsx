        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="bg-gray-50 p-8 rounded-lg shadow-md">
              <a href={getPathWithLocale('/kariyer/basvuru', locale)} className="block w-full px-8 py-4 bg-[#3d4f5f] text-white font-bold rounded-lg hover:bg-[#1a16a8] transition-colors text-center">
