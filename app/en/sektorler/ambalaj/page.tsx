...
export default function AmbalajPageEN() {
      ...
      <section className="relative py-20 md:py-32 lg:py-40 overflow-hidden">
        ...
        <div className="relative container mx-auto px-4 text-white">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 max-w-3xl">
            {t.sectors.ambalaj.title}
          </h1>
          <p className="text-xl md:text-2xl text-gray-100 max-w-3xl">
            {t.sectors.ambalaj.subtitle}
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-[#261dcf] mb-6">
              {t.sectors.ambalaj.aboutTitle}
            </h2>
            <div className="prose prose-lg max-w-none text-gray-700 space-y-4">
              <p>{t.sectors.ambalaj.aboutText1}</p>
              <p>{t.sectors.ambalaj.aboutText2}</p>
              <p>{t.sectors.ambalaj.aboutText3}</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="relative py-16 md:py-24 text-white overflow-hidden">
        <div className="absolute inset-0">
          <img 
            ...
            alt={t.sectors.ambalaj.ctaTitle}
            className="w-full h-full object-cover"
          />
        ...
        <div className="relative container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              {t.sectors.ambalaj.ctaTitle}
            </h2>
            <p className="text-xl mb-8 text-gray-100">
              {t.sectors.ambalaj.ctaDescription}
            </p>
