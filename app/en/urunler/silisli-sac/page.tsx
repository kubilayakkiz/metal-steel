      ...
      <section className="relative py-20 md:py-32 lg:py-40 overflow-hidden text-white">
        ...
        <div className="relative container mx-auto px-4">
          ...
          <p className="text-xl md:text-2xl text-gray-100 max-w-3xl">
            High quality silicon sheet products
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none text-gray-700 space-y-4">
              <p>
                Silicon sheet is a steel sheet product with high silicon content. This special alloy 
                offers superior properties in terms of magnetic properties and electrical performance.
              </p>
              <p>
                Metal X Endüstriyel San. ve Tic. LTD. ŞTİ.'s silicon sheet products are widely used in electric motors, transformers, 
                generators and other electrical devices. Our products are produced in accordance with 
                high quality standards and meet the highest expectations of our customers.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="relative container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8 text-gray-100">
              Contact us for detailed information and quotes about our silicon sheet products.
            </p>
