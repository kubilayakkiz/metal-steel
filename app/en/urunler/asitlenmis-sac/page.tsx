...
export default function AsitlenmisSacPage() {
      ...
      <section className="relative py-20 md:py-32 lg:py-40 overflow-hidden text-white">
        ...
        <div className="relative container mx-auto px-4">
          ...
          <p className="text-xl md:text-2xl text-gray-100 max-w-3xl">
            High quality pickled sheet products
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none text-gray-700 space-y-4">
              <p>
                Pickled sheet is a steel sheet product whose oxide layer is removed by surface cleaning 
                process. This process removes the oxide layer on the surface of the sheet, providing a 
                clean and smooth surface.
              </p>
              <p>
                Metal X Endüstriyel San. ve Tic. LTD. ŞTİ.'s pickled sheet products are widely used in automotive, construction, machinery 
                manufacturing and general industrial applications. Our products are produced in accordance 
        ...
        <div className="relative container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8 text-gray-100">
              Contact us for detailed information and quotes about our pickled sheet products.
            </p>
