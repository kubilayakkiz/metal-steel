...
export default function NPUProfillerPageEN() {
    ...
    <div className="w-full">
      <section className="relative py-20 md:py-32 lg:py-40 overflow-hidden text-white">
        <div className="absolute inset-0">
          <img src="/insaatdemiri.jpg" alt="NPU Profiles" className="w-full h-full object-cover" />
          <div className="absolute inset-0 bg-gradient-to-br from-[#3d4f5f]/90 to-[#1a1a5e]/90" />
        </div>
        <div className="relative container mx-auto px-4">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 max-w-3xl">NPU Profiles</h1>
          <p className="text-xl md:text-2xl text-gray-100 max-w-3xl">Wide-base channel (U) profiles – NPU series</p>
        </div>
      </section>

      <ProductSectionWithImage src="/insaatdemiri.jpg" alt="NPU Profiles" imagePosition="left">
        <h2 className="text-3xl md:text-4xl font-bold text-[#3d4f5f] mb-6">About the Product</h2>
        <div className="prose prose-lg max-w-none text-gray-700 space-y-4">
          <p>
            NPU profiles are wide-base U-channel profiles compared to NPI, offering better stability and load
            distribution. They are preferred for heavy load bearing, machine bases, and industrial structures.
          </p>
          <p>
            Metal X supplies NPU profiles from NPU 65 to NPU 400 in standard sizes.
          </p>
        </div>
      </ProductSectionWithImage>

      <ProductSectionWithImage src="/insaatdemiri.jpg" alt="NPU Profiles" imagePosition="right" bgColor="gray">
      ...
      <section className="relative py-16 md:py-24 text-white overflow-hidden">
        ...
        <div className="relative container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8 text-gray-100">Contact us for detailed information and quotes on our NPU profile products.</p>
