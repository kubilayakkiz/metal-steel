          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-gray-50 p-8 rounded-lg">
                <h3 className="text-xl font-bold text-[#3d4f5f] mb-4">Koyu Arka Plan</h3>
              ...
              <div className="bg-gray-50 p-8 rounded-lg">
                <h3 className="text-xl font-bold text-[#3d4f5f] mb-4">Açık Arka Plan</h3>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-white p-6 rounded-lg shadow-md">
                <h3 className="text-xl font-bold text-[#3d4f5f] mb-4">Ana Renk</h3>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                <h3 className="text-xl font-bold text-[#3d4f5f] mb-4">Vurgu Rengi</h3>
                <div className="flex items-center gap-4 mb-4">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="text-xl font-bold text-[#3d4f5f] mb-4">Ana Font</h3>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-white p-6 rounded-lg shadow-md text-center">
                ...
                <h3 className="text-lg font-bold text-[#3d4f5f] mb-2">Güvenilirlik</h3>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md text-center">
                ...
                <h3 className="text-lg font-bold text-[#3d4f5f] mb-2">Yenilikçilik</h3>
                <p className="text-gray-600 text-sm">
              ...
              <div className="bg-white p-6 rounded-lg shadow-md text-center">
                ...
                <h3 className="text-lg font-bold text-[#3d4f5f] mb-2">Sürdürülebilirlik</h3>
                <p className="text-gray-600 text-sm">
