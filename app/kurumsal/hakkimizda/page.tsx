            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-gray-50 p-6 rounded-lg shadow-md">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-bold text-lg mb-2 text-[#261dcf]">Doğru ürün seçimi</h3>
              ...
              <div className="bg-gray-50 p-6 rounded-lg shadow-md">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-bold text-lg mb-2 text-[#261dcf]">Termin disiplini</h3>
              ...
              <div className="bg-gray-50 p-6 rounded-lg shadow-md">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-bold text-lg mb-2 text-[#261dcf]">Güçlü tedarik ağı</h3>
              ...
              <div className="bg-gray-50 p-6 rounded-lg shadow-md">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-bold text-lg mb-2 text-[#261dcf]">Şeffaf iletişim</h3>
              ...
              <div className="bg-gray-50 p-6 rounded-lg shadow-md md:col-span-2">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-bold text-lg mb-2 text-[#261dcf]">Uzun vadeli ortaklık</h3>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-white p-6 rounded-lg shadow-md">
                <h3 className="text-xl font-bold text-[#261dcf] mb-3">Güven</h3>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                <h3 className="text-xl font-bold text-[#261dcf] mb-3">Hız</h3>
                <p className="text-gray-700">
                  Teklif, onay, termin ve sevkiyatta çevik operasyon
                </p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-md">
                <h3 className="text-xl font-bold text-[#261dcf] mb-3">Şeffaflık</h3>
                <p className="text-gray-700">
